  ...
  return (
    <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-white/5">
      <div className="mx-auto max-w-6xl px-6 py-5 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm relative" style={{ fontFamily: 'Poppins' }}>
          {/* PRODUCTS MEGA MENU */}
          ...
          <button onClick={() => onNav('about')} className="hover:opacity-80">About</button>
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden min-h-[80vh]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-32 text-white">
          ...
          >
            {[
              ...
              >
                ...
                <p className="text-sm text白/70 leading-snug">{itemData.desc}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <p className="mt-2">
              Security & Compliance — Achieve modernization without disruption,
              while integrating legacy systems.
            </p>
            <a
              href="#about"
...
/* ===========================
   About Page (content from deck, styled)
=========================== */
function AboutPage({ onNav }) {
  return (
    <>
      <Breadcrumbs onNav={onNav} items={[{label:'Home', key:'home'},{label:'About', key:null}]} />

      {/* HERO */}
      <section className="bg-gradient-to-b from-[#0E1726] to-[#152238] text-white">
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold" style={{ fontFamily:'Poppins' }}>About MarTerra</h1>
            <p className="mt-4 text-white/85">High performance, lower cost, faster ROI — we unify modern physical security so organizations can protect people, property, and critical infrastructure with confidence.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white text-[#0E1726]">
        <div className="mx-auto max-w-6xl px-6 py-16 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold" style={{ fontFamily:'Poppins' }}>Our Mission</h2>
            <p className="mt-3 text-[#444]">To deliver unified, intelligent security that’s simple to deploy, effortless to manage, and powerful in outcomes — from docks and gates to campuses and enterprises.</p>
          ...
          <div className="rounded-2xl bg-[#F6F8FB] p-6">
            <img src="/assets/250228_Family_Portrait_Square0120_Levels-Edit.png" alt="Unified Ecosystem" className="mx-auto h-72 w-auto object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#0E1726] text-white">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <h2 className="text-2xl md:text-3xl font-extrabold" style={{ fontFamily:'Poppins' }}>Who We Serve</h2>
          <p className="mt-3 text-white/80 max-w-3xl">From marinas and ports to public venues, construction sites, schools and campuses — we tailor deployments to the realities of each site.</p>
          <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {['Marinas & Ports','Public Venues','Construction','Schools & Campuses'].map((label) => (
              <div key={label} className="rounded-2xl border border-white/15 bg-white/5 p-5">
                ...
                <p className="mt-2 text-sm text-white/70">Cameras, access, intercom, sensors, and alarms — unified in the cloud.</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white text-[#0E1726]">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <h2 className="text-2xl md:text-3xl font-extrabold" style={{ fontFamily:'Poppins' }}>Why MarTerra</h2>
          <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              {t:'High Performance, Lower Cost, Faster ROI', d:'Deploy quickly, operate efficiently, and reduce TCO.'},
              {t:'Predictive Security', d:'Proactively detect risks and adapt in real time with AI analytics.'},
              {t:'Secure Critical Infrastructure', d:'Harden perimeters and access with cloud-first designs.'},
              {t:'Protect High-Value Assets', d:'Safeguard operations through automation and intelligence.'},
            ].map((c) => (
              <div key={c.t} className="rounded-2xl border border-[#E6E9EF] bg-white p-6">
      ...
      <section className="bg-[#0E1726] text-white">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <h2 className="text-2xl md:text-3xl font-extrabold" style={{ fontFamily:'Poppins' }}>Our Approach</h2>
          <div className="mt-8 grid gap-6 md:grid-cols-4">
            {[
              {s:'1. Assess', d:'Site survey, risk analysis, and modernization plan.'},
              {s:'2. Deploy', d:'Rapid rollout with minimal downtime and clean handoff.'},
              {s:'3. Integrate', d:'Connect legacy systems and unify devices in the cloud.'},
              {s:'4. Optimize', d:'Training, tuning, and ongoing analytics-driven improvements.'},
            ].map((step) => (
              <div key={step.s} className="rounded-2xl border border-white/15 bg-white/5 p-5">
      ...
      <section className="bg-white text-[#0E1726]">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <h2 className="text-2xl md:text-3xl font-extrabold" style={{ fontFamily:'Poppins' }}>Partners & Certifications</h2>
          <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-2xl border border-[#E6E9EF] bg-white p-6 flex items-center justify-center">
              <img src="/assets/Verkada-Logo-Authorized%20Reseller_White%20(1).png" alt="Verkada Authorized Reseller" className="h-10 w-auto" />
            </div>
            ...
            <div className="rounded-2xl border border-[#E6E9EF] bg-white p-6">
              ...
              <p className="mt-2 text-sm text-[#444]">Design services, deployment assistance, and ongoing success management.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#0E1726] text-white">
        <div className="mx-auto max-w-6xl px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <h3 className="text-2xl md:text-3xl font-extrabold mt-2" style={{ fontFamily:'Poppins' }}>Get a tailored security plan</h3>
            <p className="mt-2 text-white/80">We’ll assess your sites and design a roadmap to unified protection.</p>
          </div>
...
function Footer() {
  return (
    <footer className="bg白 text-[#0E1726]">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0E1726] text-white">
      ...
      {/* Future: {page==='marina' && <MarinaIndustryPage />} {page==='access' && <AccessProductPage />} */}
      <Footer />
    </div>
  );
}
